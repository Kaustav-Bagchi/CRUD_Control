...
<html:form action="/localloginaction.do"  method="post">
    <div align="center">
    <h3>
  ...
  <table align="center" width="229">
    ...
    <tr>
      <td><html:checkbox property="serialize">Serialize user object</html:checkbox></td>
      <td>&nbsp;</td>
    </tr>
  </table>
  <table align="center" width="43%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="48%"> 
        <div align="right">US 
          <html:radio property="fromCntryCd" value="US"></html:radio>
        </div>
      </td>
      <td width="52%"> 
        <div align="left">Canada 
          <html:radio property="fromCntryCd" value="CA"></html:radio>
        </div>
      </td>
      <td width="52%"> 
      ...
      <td width="52%"> 
        <div align="left"> 
          <html:select property="language">
	          ...
	          <html:option value="en">Espanol</html:option>
